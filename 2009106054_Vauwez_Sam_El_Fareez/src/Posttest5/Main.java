...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        // example item
        itemList.add(new Buku("Parallel Programming", "Barry Wilkinson, Michael Allen", 2005, 1, 2, "Pearson Education, Inc."));
    ...
    public static void tambahItem() throws IOException {
        ...
        System.out.println("Untuk penulis yang lebih dari satu, pisahkan dengan tanda koma\n");
    ...
    public static void lihatItem() {
        ...
        for (int i = 0; i < itemList.size(); i++) {
            ...
            if (item.getPenulis().length >= 3) {
                // Sagan, et al.
                String penulisPertama = item.getPenulis()[0];
                String[] namaPenulisPertamaPerKata = penulisPertama.split(" ");
                penulis = namaPenulisPertamaPerKata[namaPenulisPertamaPerKata.length - 1] + ", et al.";
            } else if (item.getPenulis().length == 2) {
                // Sagan dan Kolbert
                String penulisPertama = item.getPenulis()[0];
                String penulisKedua = item.getPenulis()[1];
                String[] namaPenulisPertamaPerKata = penulisPertama.split(" ");
                String[] namaPenulisKeduaPerKata = penulisKedua.split(" ");

                penulis = namaPenulisPertamaPerKata[namaPenulisPertamaPerKata.length - 1] + " dan " + namaPenulisKeduaPerKata[namaPenulisKeduaPerKata.length - 1];
            } else {
                penulis = item.getPenulis()[0];
            }
