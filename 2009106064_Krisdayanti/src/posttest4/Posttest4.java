...
public class Posttest4 {
    ...
    static void addGroup() throws IOException{
        ...
        int jml_album = Integer.parseInt(input.readLine());
        System.out.print("Lighstick         : ");
        ...
        Groupband newGroup = new Groupband(pc_member, fan, alamat, email, tanggal, pcBias, nama, gender, album, kategori, jml_album, lightstick, pc);
        newGroup.done();
        newGroup.info();
    ...
    static void addSolo() throws IOException{
        ...
        Solo newSolo = new Solo(group, fan, alamat, email, tanggal, nama, gender, album, kategori, jml_album, lightstick, pc);
        newSolo.done();
        newSolo.info();
        ...
        if(dataGroup.isEmpty()){
            ...
            for (Groupband group : dataGroup) {
                if (group.getFan().equals(edit)) {
                    ...
                    System.out.print("Kategori          : " );
                    group.setKategori("Group Band");
                    System.out.print("\nGroup Band        : ");
                    group.setNama(input.readLine());
                    System.out.print("Gender            : ");
                    group.setGender(input.readLine());
                    System.out.print("Album             : ");
                    group.setAlbum(input.readLine());
                    System.out.print("Jumlah Album      : ");
                    group.setJml_album(Integer.parseInt(input.readLine()));
                    System.out.print("Lighstick         : ");
        ...
        if(dataSolo.isEmpty()){
            ...
            for (Solo solo : dataSolo) {
                if (solo.getFan().equals(edit)) {
                    ...
                    System.out.print("Kategori          : ");
                    solo.setKategori("Solo");
                    System.out.print("\nSoloist           : ");
                    solo.setNama(input.readLine());
                    System.out.print("Member of         : ");
                    solo.setGroup(input.readLine());
                    System.out.print("Gender            : ");
                    solo.setGender(input.readLine());
                    System.out.print("Solo Album        : ");
                    solo.setAlbum(input.readLine());
                    System.out.print("Jumlah Album      : ");
                    solo.setJml_album(Integer.parseInt(input.readLine()));
                    System.out.print("Lighstick         : ");
