        ...
        System.out.println("||******************************||");
            ...
            switch (menu) {
                case 1:
                    ...
                    if (pilihan == 1) {
                        System.out.println("Masukan namacalonkepaladaerah : ");
                        namacalonkepaladaerah = input.readLine();
                        System.out.println("Masukan namacalonwakil : ");
                        String namacalonwakil = input.readLine();
                        System.out.println("Masukan nomorurut : ");
                ...
                case 3:
                    ...
                    pilihan = Integer.parseInt(input.readLine());
                    if (pilihan == 1) {
                        System.out.println("Masukan nomorurut1 : ");
                        String norut = input.readLine();
                        for (nomorurut1 i : datanomorurut1) {
                            if (i.getNomorurut().equals(norut)) {
                                System.out.println("Masukan namacalonkepaladaerah baru : ");
                                i.setNamacalonkepaladaerah(input.readLine());
                                System.out.println("Masukan namacalonwakil baru : ");
                                i.setNamacalonwakil(input.readLine());
                                System.out.println("Masukan nomorurut baru : ");
                                i.setNomorurut(input.readLine());
                                System.out.println("Masukan partai baru : ");
