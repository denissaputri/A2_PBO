...
public final class main {
    ...
    public final static void main(String[] args) {
      ...
      brg.add( new barang(1, 3, "Moscrepe","Gamis" , 70000));
      brg.add( new barang(2, 3, "Rabbani","Khimar" , 30000));
      brg.add( new barang(3, 3, "jeans","celana" , 80000));
      prd.add( new produk(1, 3, "Moscrepe, Ballotely, Kemeja" , 300000));
      prd.add( new produk(2, 3, "Bella, paris, Rabbani" , 500000));
      prd.add( new produk(3, 3, "Kulot, joger, jeans" , 300000));
