...
//        barang.get(2).harga_Penitipan = 15000;
    ...
    public static void lihatBarang() throws IOException{
        ...
        for (int a = 0; a < barang.size(); a++){
            ...
            System.out.println("Nama Pemilik        : " + barang.get(a).getNama_penitip());
            System.out.println("Nama Barang         : " + barang.get(a).getNama_barang());
            System.out.println("Warna Barang        : " + barang.get(a).getWarna_barang());
            System.out.println("Jenis Barang        : " + barang.get(a).getJenis_barang());
            System.out.println("Jumlah Barang       : " + barang.get(a).getBanyak_barang());
            System.out.println("Waktu Terima Barang : " + barang.get(a).getWaktu_serah());
            System.out.println("Harga Penitipan     : " + barang.get(a).getHarga_penitipan());
        }
        back();
...
//        databaru.harga_Penitipan = harga_Penitipan;
    ...
    public static void updateBarang() throws IOException{
        ...
        barang.get(nomor).setNama_penitip(baru.readLine());
        System.out.print("Perbarui nama Barang : ");
        barang.get(nomor).setNama_barang(baru.readLine());
        System.out.print("Perbarui warna Barang : ");   
        barang.get(nomor).setWarna_barang(baru.readLine());
        System.out.print("Perbarui jenis Barang : ");
        barang.get(nomor).setJenis_barang(baru.readLine());
        System.out.print("Perbarui banyak Barang : ");
        barang.get(nomor).setBanyak_barang(Integer.parseInt(baru.readLine()));
        System.out.print("Perbarui jam Terima : ");
        barang.get(nomor).setWaktu_serah(baru.readLine());
        System.out.print("Perbarui Harga : ");
        barang.get(nomor).setHarga_penitipan(Integer.parseInt(baru.readLine()));
