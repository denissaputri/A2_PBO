...
public class Main {
    public static void main(String[] args) throws NumberFormatException, IOException {
        ...
        Dapes dapes1 = new Dapes(11,11,"11", 11, "11","11");
        Dapes dapes2 = new Dapes(11,11,"11", 11, "11","11");
        
        Dapel dapel1 = new Dapel(11,11,"11", 11, "11","11",11);
        Dapel dapel2 = new Dapel(11,11,"11", 11, "11","11",11);
            ...
            switch(pilih){
                case 1:   
                    ...
                    if (menu == 1){
                        ...
                        System.out.print("Tahun Mulai : ");int lama           = Integer.parseInt(input.readLine());    
                        System.out.println("******************************\n");
                        Dapel newData = new Dapel(id_pelatih, nik, nama, umur, gender, bidang_umkm, lama);
                        ...
                        System.out.print("Bidang UMKM : ");String bidang_umkm = input.readLine();
                        System.out.println("******************************\n");
                        Dapes dataBaru = new Dapes(no_peserta, nik, nama, umur, gender, bidang_umkm);
