...
public class Main {
    ...
    public static void readBarang()throws IOException{
        for (int i = 0; i < dataBarang.size(); i++){
            ...
            System.out.println("Nama barang : " + dataBarang.get(i).getNama());
            System.out.println("Harga Barang: " + dataBarang.get(i).getHarga());
            System.out.println("Jumlah stock: " + dataBarang.get(i).getStock());
            System.out.println("Jenis stock : " + dataBarang.get(i).getJenis());
    ...
    public static void updateBarang()throws IOException {
        ...
        System.out.print("Masukan nama barang : ");
        input1 = br.readLine();
        dataBarang.get(indexe).setNama(input1);
        System.out.print("Masukan harga barang : ");
        input2 = Integer.parseInt(br.readLine());
        dataBarang.get(indexe).setHarga(input2);
        System.out.print("Masukan stock barang : ");
        input3 = Integer.parseInt(br.readLine());
        dataBarang.get(indexe).setStock(input3);
        System.out.print("Masukan Jenis barang : ");
        input4 = br.readLine();
        dataBarang.get(indexe).setJenis(input4);
